...
function runGame(gameType) {
   ...
   if (gameType === "addition") {
    ...
    dislplaySubtractQuestion(num1, num2);
   } 
    else {
...
/**
 * Gets the cureent score from the DOM and increments it by 1
 */
...
/**
 * Gets the cureent tall of incorrect answers from the DOM and increments it by 1
 */
...
function dislplaySubtractQuestion (operand1, operand2) {
